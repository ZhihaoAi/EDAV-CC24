...
Tukey, John W. 1977. [Exploratory Data Analysis.](https://clio.columbia.edu/catalog/136422) Addison-Wesley. (Chapter 2): the primary source in which boxplots are first presented. 

[Article on boxplots with ggplot2](http://t-redactyl.io/blog/2016/04/creating-plots-in-r-using-ggplot2-part-10-boxplots.html): An excellent collection of code examples on how to make boxplots with ggplot2. Covers layering, working with legends, faceting, formatting, and more. If you want a boxplot to look a certain way, this article will help. 

[Boxplots with plotly package](https://plot.ly/ggplot2/box-plots/): boxplot examples using the plotly package. These allow for a little interactivity on hover, which might better explain the underlying statistics of your plot.

[ggplot2 Boxplot: Quick Start Guide](http://www.sthda.com/english/wiki/ggplot2-box-plot-quick-start-guide-r-software-and-data-visualization): Article from STHDA on making boxplots using ggplot2. Excellent starting point for getting immediate results and custom formatting.

[ggplot2 cheatsheet](https://rstudio.com/wp-content/uploads/2015/03/ggplot2-cheatsheet.pdf): Always good to have close by.

[Hadley Wickhan and Lisa Stryjewski on boxplots](http://vita.had.co.nz/papers/boxplots.pdf): good for understanding basics of more complex boxplots and some of the history behind them.
...
[Introduction to ggridges](https://cran.r-project.org/web/packages/ggridges/vignettes/introduction.html): An excellent collection of code examples on how to make ridgeline plots with ggplot2. Covers every parameter of ggridges and how to modify them for better visualization. If you want a ridgeline plot to look a certain way, this article will help.

[Article on ridgeline plots with ggplot2](https://rdrr.io/cran/ggridges/man/geom_density_ridges.html): Few examples using different examples. Great for starting with ridgeline plots.

[History of Ridgeline plots](https://blog.revolutionanalytics.com/2017/07/joyplots.html): To refer to the theory of ridgeline plots.
...
[Understanding Q-Q Plots](https://data.library.virginia.edu/understanding-q-q-plots/): A discussion from the University of Virginia Library on qqplots.

[How to interpret a QQ plot](https://stats.stackexchange.com/questions/101274/how-to-interpret-a-qq-plot): Another resource for interpreting qqplots.

[A QQ Plot Dissection Kit](http://seankross.com/2016/02/29/A-Q-Q-Plot-Dissection-Kit.html): An excellent walkthrough on qqplots by Sean Kross.

[Probability plotting methods for the analysis of data](https://www.jstor.org/stable/2334448?seq=1#metadata_info_tab_contents): Paper on plotting techniques, which discusses qqplots. (Wilk, M.B.; Gnanadesikan, R. (1968))

[QQ-Plot Wiki](https://en.wikipedia.org/wiki/Q%E2%80%93Q_plot#cite_note-1): Wikipedia entry on qqplots
